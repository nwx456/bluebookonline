...
1. **Solve a problem cold.** No notes, no AI, no internet.
2. **Score yourself.** Use AI scoring or a trusted answer key.
3. **For every wrong answer, write your own diagnosis first.** What did you misunderstand? What would you do differently?
4. **Then ask AI for an explanation.** Compare your diagnosis to the AI version. The differences are where your real lesson lives.
5. **Re-solve a similar problem 24 hours later.** This is the test of whether the lesson stuck.
