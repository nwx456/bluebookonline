...
description: >-
  Master the May 2026 AP World History: Modern exam: 9 units from 1200-Present,
  the four-part exam format (MCQ, SAQ, DBQ, LEQ), the 7-point DBQ rubric,
  comparison strategies, and a focused study plan.
date: '2026-04-04'
updated: '2026-07-19'
...
metaDescription: >-
  Complete AP World History guide: 9 units, DBQ/LEQ strategy, and free practice
  + score calculator.
tags:
  - AP World History
  - AP World
...
draft: false
faq:
  - question: What time period does AP World History cover?
    answer: >-
      Only c. 1200 CE to the present (2001). The earlier 'Foundations' content
      was removed in the 2019-2020 redesign. Units 3-6 (1450-1900) carry the
      heaviest weight at 12-15% each.
  - question: How long is the AP World History exam?
    answer: >-
      The exam is 3 hours 15 minutes total: Section IA (55 MCQs, 55 min),
      Section IB (3 SAQs, 40 min), Section II Part A (DBQ, 60 min including
      15-min reading), and Section II Part B (LEQ, 40 min).
  - question: How is AP World History different from AP US History?
    answer: >-
      AP World History is global and comparative; APUSH is single-nation. The
      DBQ and LEQ rubrics are nearly identical (7-point DBQ, 6-point LEQ). World
      History DBQ topics span 1450-2001 instead of APUSH's 1754-1980.
  - question: Should I take AP World History before or after APUSH?
    answer: >-
      Either order works. Taking AP World History first builds historical
      thinking skills (CCOT, comparison, causation) that transfer directly to
      APUSH and AP European History. Many schools schedule World History in 10th
      grade and APUSH in 11th grade.
sources:
  - name: 'College Board AP World History: Modern CED'
    url: 'https://apcentral.collegeboard.org/courses/ap-world-history-modern'
verifiedDate: July 2026
---
**Short answer:** The 2026 AP World History: Modern exam is Thu, May 7, 2026 (8 AM Local) — 55 MCQs, 195 minutes total, fully digital in Bluebook.
...
1. **Contextualization** — placing events in broader global context.
2. **Comparison** — identifying similarities and differences across regions, empires, or time periods.
3. **Causation** — explaining causes and effects of historical developments.
4. **Continuity and Change Over Time (CCOT)** — what stayed the same and what changed.
...
1. **Read the prompt twice.** Underline the verb (compare, evaluate causes, analyze CCOT) and the time period.
2. **Read each document** (90 seconds each). Note: "supports thesis," "complicates thesis," "counterexample."
3. **Group documents by perspective or theme** (2-3 groups).
4. **Write a thesis** that takes a defensible position responding to the prompt.
5. **Outline 5 paragraphs**: intro, 2-3 body paragraphs, complexity paragraph, conclusion.
...
1. **Vague theses.** "There were many causes of industrialization" wins zero points. "Industrialization in Britain was driven primarily by capital accumulation from the slave trade and colonial extraction, more than by domestic technological innovation alone" wins.
2. **Document summary instead of analysis.** Always connect back to the thesis.
3. **Ignoring time-period limits.** If the DBQ is 1750-1900, do not write about WWI.
4. **Forgetting outside evidence.** Specific, accurate, NOT mentioned in the documents.
5. **Skipping contextualization.** It is a free point. Spend 2 sentences before the thesis describing the broader era.
6. **No complexity sentence.** Add a paragraph that qualifies, modifies, or compares your argument with a contrasting perspective.
7. **Writing about Europe only.** AP World is global — for at least one body paragraph, address a non-European region.
