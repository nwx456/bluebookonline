...
export interface ExamHeaderProps {
  ...
  /** Inline source label shown beside Directions (same row, no extra header height). */
        ...
        <div className="md:hidden">
          <div className="flex items-start justify-between gap-2 px-3 py-2">
            <div className="min-w-0 flex-1">
              ...
              <div className="relative mt-0.5 flex min-w-0 flex-wrap items-center gap-x-3 gap-y-0">
                <button
                  type="button"
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="relative mt-0.5 flex min-w-0 flex-wrap items-center gap-x-3 gap-y-0">
            <button
              type="button"
              onClick={onToggleDirections}
              className="flex shrink-0 items-center gap-1 text-base text-gray-600 hover:text-gray-900"
            >
